...
|----------|-------------|
| [=Ä White Paper](./docs/whitepaper.md) | Complete framework specification v2.1 |
| [=à Implementation Guide](./docs/implementation-guide.md) | Step-by-step development guide |
| [=Ê Case Studies](./docs/case-studies.md) | Real-world examples and results |
...
- **Ä-bench**: "A Benchmark for Tool-Agent-User Interaction in Real-World Domains" - arXiv:2406.12045
...
- =ç Contact: [joel@goldfoot.com](mailto:joel@goldfoot.com)
